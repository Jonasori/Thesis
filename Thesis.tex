...
% REWORK: Took out space from \hco. If spaces are not being added, add a tilde to force one
\newcommand{\hco}{HCO$^+$}
\newcommand{\kms}{km\,s$^{-1}$}
\newcommand{\decarcsec}{\rlap{.}$''$}
\newcommand{\arcsec}{$''$}
...
{\LARGE \singlespacing \bf Exploring the Role of Environment in the Composition of ONC Proplyds} \\
\vspace*{0.05in}
\vspace*{0.10in}
...
\rule{5.75in}{1pt} \\
\vspace*{-0.125in}
{\large \doublespacing Middletown, Connecticut \hfill May, 2019}
\rule[0.2in]{5.75in}{1pt} \\
\end{center}
\end{titlepage}
