...
% Ex reference: \citep{howell2014}

\iffalse
Not sure what 'afterpage' is:
...
\begin{figure}[ht!]
\centering
\includegraphics[height=0.8\textheight]{K2Field.pdf}
\caption{\label{fig:k2field} Different K2 fields of observation in galactic coordinates up to Campaign 18 are shown. \ketu observed different parts of the ecliptic planet with field overlapping between subsequent campaigns. Note that Campaign 5 and Campaign 18 fields overlap perfectly.}
\end{figure}
\end{landscape}
\clearpage}
\fi
