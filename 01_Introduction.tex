...
\begin{figure}[htp]
  ...
  \hspace*{\fill}%
  \captionof{figure}{Images of V2434 Ori taken from \citet{Smith2005} on HST (Fig. \ref{fig:v2434ori_smith05}), \citet{MannWilliams2009} with the SMA at 880 $\mu$m (Fig. \ref{fig:v2434ori_mann09}), and \citet{Ricci2011} with the EVLA (overlaid on a colorized version of the HST data) at 7mm (Fig. \ref{fig:v2434ori_ricci11}). The ionization front and jet from disk A are clearly visible in the HST image.}
\end{figure}
