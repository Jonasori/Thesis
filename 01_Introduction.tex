...
\centering
  ...
  \captionof{figure}{Proplyds in the Orion Nebula. The closer a proplyd is to a large, bright star, the more visibly windswept it is. Image courtesy of the Hubble Space Telescope Treasury Program on the Orion Nebula \citep{Robberto2013}.}
  \label{fig:HST_ONC}
\end{figure}
...
\begin{figure}[htp]
  ...
  \hspace*{\fill}%
  \captionof{figure}{Images of V2434 Ori taken from \citet{Smith2005} on HST (Fig. \ref{fig:v2434ori_smith05}), \citet{MannWilliams2009} with the SMA at 880 $\mu$m (Fig. \ref{fig:v2434ori_mann09}), and \citet{Ricci2011} with the EVLA (overlaid on a colorized version of the HST data) at 7 mm (Fig. \ref{fig:v2434ori_ricci11}). The ionization front and jet from disk A are clearly visible in the HST image.}
\end{figure}
...
\begin{figure}[htp]
  \hspace*{\fill}%
  \subcaptionbox{\label{fig:m1map_hco}}{\includegraphics[width=0.5\linewidth]{moment1_hco-data.png}}\hfill%
  \subcaptionbox{\label{fig:m1map_hcn}}{\includegraphics[width=0.5\linewidth]{moment1_hcn-data.png}}\vfill%
  \subcaptionbox{\label{fig:m1map_co}}{\includegraphics[width=0.5\linewidth]{moment1_co-data.png}}\hfill%
  \subcaptionbox{\label{fig:m1map_cs}}{\includegraphics[width=0.5\linewidth]{moment1_cs-data.png}}\hfill%
  \hspace*{\fill}%
  \label{fig:data_moment_maps}
  \captionof{figure}{Zeroth (contours) and first (colors) moment maps of \hco(4-3), HCN(4-3), CO(3-2), and CS(7-6) emission (left to right) in the d253-1536 system, observed with ALMA's Band 7. The moment-zero maps describe the distribution of material in the disks, while moment-one maps give us a sense of the disks' velocity distributions. Moment-zero contours are trace 3, 6, 9...-$\sigma$ flux levels.}
\end{figure}
